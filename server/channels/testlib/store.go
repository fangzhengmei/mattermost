...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", "CMEEncryptionManagerRoleCreationMigrationComplete").Return(&model.System{Name: "CMEEncryptionManagerRoleCreationMigrationComplete", Value: "true"}, nil)
