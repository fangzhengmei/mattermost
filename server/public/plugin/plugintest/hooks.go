...
// CMECreateChannelKey provides a mock function with given fields: channelID
func (_m *Hooks) CMECreateChannelKey(channelID string) *plugin.CMEHookResult {
	ret := _m.Called(channelID)

	if len(ret) == 0 {
		panic("no return value specified for CMECreateChannelKey")
	}

	var r0 *plugin.CMEHookResult
	if rf, ok := ret.Get(0).(func(string) *plugin.CMEHookResult); ok {
		r0 = rf(channelID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*plugin.CMEHookResult)
		}
	}
...
// CMEDecrypt provides a mock function with given fields: channelID, ciphertexts
func (_m *Hooks) CMEDecrypt(channelID string, ciphertexts [][]byte) *plugin.CMEDecryptBatchResult {
	ret := _m.Called(channelID, ciphertexts)

	if len(ret) == 0 {
		panic("no return value specified for CMEDecrypt")
	}

	var r0 *plugin.CMEDecryptBatchResult
	if rf, ok := ret.Get(0).(func(string, [][]byte) *plugin.CMEDecryptBatchResult); ok {
		r0 = rf(channelID, ciphertexts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*plugin.CMEDecryptBatchResult)
		}
	}
...
// CMEEncrypt provides a mock function with given fields: channelID, plaintext
func (_m *Hooks) CMEEncrypt(channelID string, plaintext []byte) *plugin.CMEEncryptResult {
	ret := _m.Called(channelID, plaintext)

	if len(ret) == 0 {
		panic("no return value specified for CMEEncrypt")
	}

	var r0 *plugin.CMEEncryptResult
	if rf, ok := ret.Get(0).(func(string, []byte) *plugin.CMEEncryptResult); ok {
		r0 = rf(channelID, plaintext)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*plugin.CMEEncryptResult)
		}
	}
...
// CMERevokeChannelKey provides a mock function with given fields: channelID
func (_m *Hooks) CMERevokeChannelKey(channelID string) *plugin.CMEHookResult {
	ret := _m.Called(channelID)

	if len(ret) == 0 {
		panic("no return value specified for CMERevokeChannelKey")
	}
